...
public class AppiontmentBookingDAOImpl implements AppiontmentBookingDAO {
	...
	@Override
	public boolean addAppiontment(AppiontmentBooking appiontment,int appointmentId) {
		EntityManager manager = factory.createEntityManager();
		EntityTransaction transaction = manager.getTransaction();
		Patient patient = manager.find(Patient.class, appointmentId);
		appiontment.setAppiontmentId(appointmentId);
		if (appiontment != null) {
			try {
				transaction.begin();
